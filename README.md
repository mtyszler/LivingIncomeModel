...
_notebooks re-run on 24/10/2022 to update heroku build matching python 3.10.6 and updated dependencies_
...
This projects uses **Python 3.10.6** and was developed in windows 10 system. Python package requirements for the web app can be found in [`requirements.txt`](https://github.com/mtyszler/LivingIncomeModel/blob/main/requirements.txt).
