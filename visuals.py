...
def feature_plot(importances, X_train, y_train, n_features = 5):
    ...
    pl.title("Normalized Weights for the " + str(n_features) + " Most Predictive Features", fontsize = 16)
    ...
    pl.xticks(np.arange(n_features), columns, rotation = 'vertical')
    pl.xlim((-0.5, n_features-0.5))
